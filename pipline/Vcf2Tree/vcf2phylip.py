...
"""
"""
Build information by Mol Chai
this version is base origin V2.4, but added new commands of V2.6 version.
You can specify the output directory use parameters(-od | --out-folder) and output prefix(-op|-out-prefix).

"""

__author__      = "Edgardo M. Ortiz"
__credits__     = "Mol Chai"
__version__     = "2.46 from origin 2.4-2.6"
